...
export class PersonalTabComponent implements OnDestroy {
  ...
  isTouchedCallback(){
    let controls = this.personalFormGroup.controls
    this.isTouched = controls.firstNameControl.value! != this.accountState.firstName
  ...
  onAccountSaveClicked() {
    let accountInfo: Account = {
      ...
      birthDay: this.personalFormGroup.controls.birthdayControl.value?.toDateString()!,
